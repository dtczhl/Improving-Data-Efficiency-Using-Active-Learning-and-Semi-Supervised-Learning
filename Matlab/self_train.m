...
al_strategies = struct( ...
    'random', 'Baseline', ...
    'selfTrain_random', 'Random', ...
    'selfTrain_confident', 'Maximum Confident', ...
    'selfTrain_entropy', 'Mininum Entropy');
...
hleg = legend(aline, my_legend, 'location', 'southeast', 'fontsize', 18);
set(hleg, 'box', 'off')
