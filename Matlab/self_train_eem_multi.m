...
al_strategies = struct( ...
    ...
    'selfTrain_random_eem_multi', 'Random', ...
    'selfTrain_confident_eem_multi', 'Maximum Confident', ...
    'selfTrain_entropy_eem_multi', 'Mininum Entropy');
...
saveas(gcf, './Image/self_train_eem_multi.png')
